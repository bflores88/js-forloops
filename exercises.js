...
function capitalMyWay(lyrics){
   var myWayArr = myWay.split(" ");
   for (var i=0; i<myWayArr.length; i++){
      upperMyWayArr.push(myWayArr[i].charAt(0).toUpperCase() + myWayArr[i].slice(1));

   }
   console.log(upperMyWayArr.join(" "));
}
